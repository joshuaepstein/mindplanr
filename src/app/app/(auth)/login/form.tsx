  ...
  return (
    <div className="flex flex-col space-y-3 bg-zinc-50 px-4 py-8 sm:px-16">
      ...
      >
        {showEmailOption && (
          <div>
            <div className="mb-4 mt-1 border-t border-zinc-300" />
            <input
              id="email"
              name="email"
              autoFocus
              ...
              className="mt-1 block w-full appearance-none rounded-md border border-zinc-300 px-3 py-2 placeholder-zinc-400 shadow-sm focus:border-black focus:outline-none focus:ring-black sm:text-sm"
            />
          </div>
        )}
        <Button
