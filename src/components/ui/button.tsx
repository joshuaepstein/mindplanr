  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-300',
  {
    variants: {
      variant: {
        ...
        ghost2:
          'bg-zinc-100 hover:bg-zinc-200 text-zinc-900 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-50 hover:text-zinc-800',
        link: 'text-zinc-900 underline-offset-4 hover:underline dark:text-zinc-50',
        primary: 'bg-primary text-zinc-50 shadow-sm hover:bg-primary-700',
        primaryLink: 'text-primary underline-offset-4 hover:underline',
      },
      size: {
      ...
      scale: {
        default: '',
        normal:
          'scale-100 hover:scale-105 active:scale-95 transition-transform',
      },
    },
    defaultVariants: {
      variant: 'default',
